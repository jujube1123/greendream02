...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="/resources/css/opC.css">
...
<div id="all">
	...
	<div id="room">
		...
		기준 온도: ${adtOpC.mintem}°C~${adtOpC.maxtem}°C
		</div>
		<div id="roomHum" style=" cursor: pointer" onclick="humAd()">
		기준 습도: ${adhOpC.minhum}%~${adhOpC.maxhum}%
		</div>
	</div>
	...
	<div id='detail'>
		<div id="temDetail">
			<div id="highTem"><span id="ht">최고: ${highTemOpC[0].tdb}°C</span></div>
			<div id="lowTem"><span id="lt">최저: ${lowTemOpC[0].tdb}°C</span></div>
			<div id="averageTem"><span id="at">평균: ${averageTemOpC}°C</span></div>	
		</div>	
		<div id="humDetail">
			<div id="highHum"><span id="hh">최고: ${highHumOpC[0].hdb}%</span></div>
			<div id="lowHum"><span id="lh">최저: ${lowHumOpC[0].hdb}%</span></div>
...
<script type="text/javascript" src="/resources/js/opC.js"></script>
<script type="text/javascript" src="/resources/js/humChartsOpC.js"></script>
<script type="text/javascript" src="resources/js/temChartsOpC.js"></script>
</body>
</html>