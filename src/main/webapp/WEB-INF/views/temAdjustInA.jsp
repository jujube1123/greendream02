...
<body>
<form action="adtemInA" id="adform">
   <div class="wrapper" >
		<header>
			<h2>기준온도 조절</h2>
		...
		<div class="price-input">
			<div class="field">
				<span>Min</span>
				<input type="number" value="${adtInA.mintem}" class="min-input" name="mintem">
			</div>
			<div class="seperator">~</div>
			<div class="field">
				<span>Max</span>
				<input type="number" value="${adtInA.maxtem}" class="max-input" name="maxtem">
			</div>
		</div>
	<!-- <div class="mm">
  		...
  		<div class="range-input">
			...
			max="80" value="${adtInA.mintem}" class="min-range"> 			
  			<input type="range" min="-40"
			max="80" value="${adtInA.maxtem}" class="max-range"> 			
