...
<form action="adtemInB" id="adform">
   <div class="wrapper" >
		...
		<div class="price-input">
			<div class="field">
				<span>Min</span>
				<input type="number" value="${adtInB.mintem}" class="min-input" name="mintem">
			</div>
			<div class="seperator">~</div>
			<div class="field">
				<span>Max</span>
				<input type="number" value="${adtInB.maxtem}" class="max-input" name="maxtem">
			</div>
		</div>
	<!-- <div class="mm">
  		...
  		<div class="range-input">
			...
			max="80" value="${adtInB.mintem}" class="min-range"> 			
  			<input type="range" min="-40"
			max="80" value="${adtInB.maxtem}" class="max-range"> 			
