...
<body>
<form action="adtemOpC" id="adform">
   <div class="wrapper" >
		<header>
			<h2>기준온도 조절</h2>
		...
		<div class="price-input">
			<div class="field">
				<span>Min</span>
				<input type="number" value="${adtOpC.mintem}" class="min-input" name="mintem">
			</div>
			<div class="seperator">~</div>
			<div class="field">
				<span>Max</span>
				<input type="number" value="${adtOpC.maxtem}" class="max-input" name="maxtem">
			</div>
		</div>
	<!-- <div class="mm">
  		...
  		<div class="range-input">
			...
			max="80" value="${adtOpC.mintem}" class="min-range"> 			
  			<input type="range" min="-40"
			max="80" value="${adtOpC.maxtem}" class="max-range"> 			
