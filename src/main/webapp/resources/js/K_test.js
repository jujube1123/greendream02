	...
	// 습도
	const humidity = document.querySelector('#weather tbody td:nth-child(4)')
	// 풍향
	const wind = document.querySelector('#weather tbody td:nth-child(5)')
	// 체감온도
	const temp_min = document.querySelector('#weather tbody td:nth-child(6)')
...
const callbackOk = (position) =>{
    ...
    const url = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&lang=${lang}&humidity=${humidity}&temp_min=${temp_min}&temp_max=${temp_max}&appid=${API_KEY}&units=${units}`
